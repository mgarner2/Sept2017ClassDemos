...
public partial class SamplePages_TabbedCRUDReview : System.Web.UI.Page
{
    ...
    protected void SearchResults_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        AlbumID.Text = (agrow.FindControl("AlbumID") as Label).Text; //AlbumID is a hidden column index [0]
        AlbumTitle.Text = agrow.Cells[1].Text; // Columns in grid views are indexed Cells
